    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "742 Evergreen Terrace", "homer@springfield.net", "Homer", true, "Simpson" },
                    { 2, "742 Evergreen Terrace", "marge@springfield.net", "Marge", true, "Simpson" },
                    { 3, "742 Evergreen Terrace", "bart@springfield.net", "Bart", true, "Simpson" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, "The Fellowship of the Ring", 1, null },
                    { 2, 4, "The Two Towers", 1, null },
                    { 3, 5, "Abbey Road", 3, null },
                    { 4, 2, "The Beatles Anthology", 2, null },
                    { 5, 2, "Churchill: A Life", 1, null },
                    { 6, 2, "FDR", 1, new DateTime(2015, 12, 10, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 7, 3, "Our Band Could Be Your Life", 1, null },
                    { 8, 4, "The Return of the King", 1, null },
                    { 9, 2, "No Direction Home (DVD)", 4, null },
                    { 10, 1, "The Second World War", 1, null }
                });
